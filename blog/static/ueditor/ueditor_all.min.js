...
d.addRange(e);a.undoManger&&a.undoManger.save()}}}})}};UE.plugins.autoheight=function(){function a(){var a=this;clearTimeout(l);k||(l=setTimeout(function(){if(!a.queryCommandState||a.queryCommandState&&1!=a.queryCommandState("source"))d||(d=a.document.createElement("span"),d.style.cssText="display:block;width:0;margin:0;padding:0;border:0;clear:both;",d.innerHTML="."),e=d.cloneNode(!0),a.body.appendChild(e),j=Math.max(f.getXY(e).y+e.offsetHeight,Math.max(h.minFrameHeight,h.initialFrameHeight)),j!=
g&&(a.setHeight(j,!0),g=j),f.remove(e)},50))}var b=this;b.autoHeightEnabled=!1!==b.options.autoHeightEnabled;if(b.autoHeightEnabled){var c,d,e,g=0,h=b.options,j,l,k;b.addListener("fullscreenchanged",function(a,b){k=b});b.addListener("destroy",function(){b.removeListener("contentchange afterinserthtml keyup mouseup",a)});b.enableAutoHeight=function(){var b=this;if(b.autoHeightEnabled){var d=b.document;b.autoHeightEnabled=!0;c=d.body.style.overflowY;d.body.style.overflowY="hidden";b.addListener("contentchange afterinserthtml keyup mouseup",
a);setTimeout(function(){a.call(b)},n.gecko?100:0);b.fireEvent("autoheightchanged",b.autoHeightEnabled)}};b.disableAutoHeight=function(){b.body.style.overflowY=c||"";b.removeListener("contentchange",a);b.removeListener("keyup",a);b.removeListener("mouseup",a);b.autoHeightEnabled=!1;b.fireEvent("autoheightchanged",b.autoHeightEnabled)};b.addListener("ready",function(){b.enableAutoHeight();var c;f.on(n.ie?b.body:b.document,n.webkit?"dragover":"drop",function(){clearTimeout(c);c=setTimeout(function(){a.call(this)},
100)})})}};UE.plugins.autofloat=function(){function a(){s=!0;k.parentNode&&k.parentNode.removeChild(k);m.style.cssText=l}function b(){var b=u(c.container),d=c.options.toolbarTopOffset||0;if(0>b.top&&b.bottom-m.offsetHeight>d){var b=f.getXY(m),d=f.getComputedStyle(m,"position"),g=f.getComputedStyle(m,"left");m.style.width=m.offsetWidth+"px";m.style.zIndex=1*c.options.zIndex+1;m.parentNode.insertBefore(k,m);h||j&&n.ie?("absolute"!=m.style.position&&(m.style.position="absolute"),m.style.top=(document.body.scrollTop||
document.documentElement.scrollTop)-q+e+"px"):(n.ie7Compat&&s&&(s=!1,m.style.left=f.getXY(m).x-document.documentElement.getBoundingClientRect().left+2+"px"),"fixed"!=m.style.position&&(m.style.position="fixed",m.style.top=e+"px",("absolute"==d||"relative"==d)&&parseFloat(g)&&(m.style.left=b.x+"px")))}else a()}var c=this,d=c.getLang();c.setOpt({topOffset:0});var e=c.options.topOffset;if(!1!==c.options.autoFloatEnabled){var g=UE.ui.uiUtils,h=n.ie&&6>=n.version,j=n.quirks,l,k=document.createElement("div"),
m,q,u,s=!0,t=p.defer(function(){b()},n.ie?200:100,!0);c.addListener("destroy",function(){f.un(window,["scroll","resize"],b);c.removeListener("keydown",t)});c.addListener("ready",function(){var e;UE.ui?e=1:(alert(d.autofloatMsg),e=0);e&&(u=g.getClientRect,m=c.ui.getDom("toolbarbox"),q=u(m).top,l=m.style.cssText,k.style.height=m.offsetHeight+"px",h&&(e=document.body.style,e.backgroundImage='url("about:blank")',e.backgroundAttachment="fixed"),f.on(window,["scroll","resize"],b),c.addListener("keydown",
t),c.addListener("beforefullscreenchange",function(b,c){c&&a()}),c.addListener("fullscreenchanged",function(a,c){c||b()}),c.addListener("sourcemodechanged",function(){setTimeout(function(){b()},0)}),c.addListener("clearDoc",function(){setTimeout(function(){b()},0)}))})}};UE.plugins.pasteplain=function(){this.setOpt({pasteplain:!1,filterTxtRules:function(){function a(b){b.tagName="p";b.setStyle()}function c(a){a.parentNode.removeChild(a,!0)}return{"-":"script style object iframe embed input select",
p:{$:{}},br:{$:{}},div:function(a){for(var b,c=UE.uNode.createElement("p");b=a.firstChild();)"text"==b.type||!UE.dom.dtd.$block[b.tagName]?c.appendChild(b):c.firstChild()?(a.parentNode.insertBefore(c,a),c=UE.uNode.createElement("p")):a.parentNode.insertBefore(b,a);c.firstChild()&&a.parentNode.insertBefore(c,a);a.parentNode.removeChild(a)},ol:c,ul:c,dl:c,dt:c,dd:c,li:c,caption:a,th:a,tr:a,h1:a,h2:a,h3:a,h4:a,h5:a,h6:a,td:function(a){a.innerText()&&a.parentNode.insertAfter(UE.uNode.createText(" &nbsp; &nbsp;"),
a);a.parentNode.removeChild(a,a.innerText())}}}()});var a=this.options.pasteplain;this.commands.pasteplain={queryCommandState:function(){return a?1:0},execCommand:function(){a=!a|0},notNeedUndo:1}};UE.plugins.video=function(){function a(a,b,g,f,j,l){return!l?"<img "+(f?'id="'+f+'"':"")+' width="'+b+'" height="'+g+'" _url="'+a+'" class="edui-faked-video" src="'+c.options.UEDITOR_HOME_URL+'themes/default/images/spacer.gif" style="background:url('+c.options.UEDITOR_HOME_URL+"themes/default/images/videologo.gif) no-repeat center center; border:1px solid gray;"+
(j?"float:"+j+";":"")+'" />':'<embed type="application/x-shockwave-flash" class="edui-faked-video" pluginspage="http://www.macromedia.com/go/getflashplayer" src="'+a+'" width="'+b+'" height="'+g+'"'+(j?' style="float:'+j+'"':"")+' wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="never" allowfullscreen="true" >'}function b(b,c){p.each(b.getNodesByTagName(c?"img":"embed"),function(b){if("edui-faked-video"==b.getAttr("class")){var d=a(c?b.getAttr("_url"):b.getAttr("src"),
b.getAttr("width"),b.getAttr("height"),null,b.getStyle("float")||"",c);b.parentNode.replaceChild(UE.uNode.createElement(d),b)}})}var c=this;c.addOutputRule(function(a){b(a,!0)});c.addInputRule(function(a){b(a)});c.commands.insertvideo={execCommand:function(b,e){e=p.isArray(e)?e:[e];for(var g=[],h=0,j,l=e.length;h<l;h++)j=e[h],g.push(a(j.url,j.width||420,j.height||280,"tmpVedio"+h,null,!1));c.execCommand("inserthtml",g.join(""),!0);g=this.selection.getRange();h=0;for(l=e.length;h<l;h++)j=this.document.getElementById("tmpVedio"+
h),f.removeAttributes(j,"id"),g.selectNode(j).select(),c.execCommand("imagefloat",e[h].align)},queryCommandState:function(){var a=c.selection.getRange().getClosedNode();return a&&"edui-faked-video"==a.className?1:0}}};var J=UE.UETable=function(a){this.table=a;this.indexTable=[];this.selectedTds=[];this.cellsRange={};this.update(a)};J.removeSelectedClass=function(a){p.each(a,function(a){f.removeClasses(a,"selectTdClass")})};J.addSelectedClass=function(a){p.each(a,function(a){f.addClass(a,"selectTdClass")})};
J.isEmptyBlock=function(a){var b=RegExp(f.fillChar,"g");if(0<a[n.ie?"innerText":"textContent"].replace(/^\s*$/,"").replace(b,"").length)return 0;for(var c in s.$isNotEmpty)if(s.$isNotEmpty.hasOwnProperty(c)&&a.getElementsByTagName(c).length)return 0;return 1};J.getWidth=function(a){return!a?0:parseInt(f.getComputedStyle(a,"width"),10)};J.getTableCellAlignState=function(a){!p.isArray(a)&&(a=[a]);var b={},c=["align","valign"],d=null,e=!0;p.each(a,function(a){p.each(c,function(c){d=a.getAttribute(c);
if(!b[c]&&d)b[c]=d;else if(!b[c]||d!==b[c])return e=!1});return e});return e?b:null};J.getTableItemsByRange=function(a){var b=a.selection.getStart();b&&(b.id&&0===b.id.indexOf("_baidu_bookmark_start_"))&&(b=b.nextSibling);var c=(a=b&&f.findParentByTagName(b,["td","th"],!0))&&a.parentNode,b=b&&f.findParentByTagName(b,"caption",!0);return{cell:a,tr:c,table:b?b.parentNode:c&&c.parentNode.parentNode,caption:b}};J.getUETableBySelected=function(a){return(a=J.getTableItemsByRange(a).table)&&a.ueTable&&a.ueTable.selectedTds.length?
a.ueTable:null};J.getDefaultValue=function(a,b){var c={thin:"0px",medium:"1px",thick:"2px"},d,e,g;if(b)h=b.getElementsByTagName("td")[0],g=f.getComputedStyle(b,"border-left-width"),d=parseInt(c[g]||g,10),g=f.getComputedStyle(h,"padding-left"),e=parseInt(c[g]||g,10),g=f.getComputedStyle(h,"border-left-width"),c=parseInt(c[g]||g,10);else{b=a.document.createElement("table");b.insertRow(0).insertCell(0).innerHTML="xxx";a.body.appendChild(b);var h=b.getElementsByTagName("td")[0];g=f.getComputedStyle(b,
"border-left-width");d=parseInt(c[g]||g,10);g=f.getComputedStyle(h,"padding-left");e=parseInt(c[g]||g,10);g=f.getComputedStyle(h,"border-left-width");c=parseInt(c[g]||g,10);f.remove(b)}return{tableBorder:d,tdPadding:e,tdBorder:c}};J.getUETable=function(a){var b=a.tagName.toLowerCase();a="td"==b||"th"==b||"caption"==b?f.findParentByTagName(a,"table",!0):a;a.ueTable||(a.ueTable=new J(a));return a.ueTable};J.cloneCell=function(a,b,c){if(!a||p.isString(a))return this.table.ownerDocument.createElement(a||
"td");var d=f.hasClass(a,"selectTdClass");d&&f.removeClasses(a,"selectTdClass");var e=a.cloneNode(!0);b&&(e.rowSpan=e.colSpan=1);!c&&f.removeAttributes(e,"width height");!c&&f.removeAttributes(e,"style");e.style.borderLeftStyle="";e.style.borderTopStyle="";e.style.borderLeftColor=a.style.borderRightColor;e.style.borderLeftWidth=a.style.borderRightWidth;e.style.borderTopColor=a.style.borderBottomColor;e.style.borderTopWidth=a.style.borderBottomWidth;d&&f.addClass(a,"selectTdClass");return e};J.prototype=
{getMaxRows:function(){for(var a=this.table.rows,b=1,c=0,d;d=a[c];c++){for(var e=1,g=0,f;f=d.cells[g++];)e=Math.max(f.rowSpan||1,e);b=Math.max(e+c,b)}return b},getMaxCols:function(){for(var a=this.table.rows,b=0,c={},d=0,e;e=a[d];d++){for(var g=0,f=0,j;j=e.cells[f++];)if(g+=j.colSpan||1,j.rowSpan&&1<j.rowSpan)for(var l=1;l<j.rowSpan;l++)c["row_"+(d+l)]?c["row_"+(d+l)]++:c["row_"+(d+l)]=j.colSpan||1;g+=c["row_"+d]||0;b=Math.max(g,b)}return b},getCellColIndex:function(){},getHSideCell:function(a,b){try{var c=
this.getCellInfo(a),d,e,g=this.selectedTds.length,f=this.cellsRange;if(!b&&(!g?!c.colIndex:!f.beginColIndex)||b&&(!g?c.colIndex==this.colsNum-1:f.endColIndex==this.colsNum-1))return null;d=!g?c.rowIndex:f.beginRowIndex;e=!b?!g?1>c.colIndex?0:c.colIndex-1:f.beginColIndex-1:!g?c.colIndex+1:f.endColIndex+1;return this.getCell(this.indexTable[d][e].rowIndex,this.indexTable[d][e].cellIndex)}catch(j){}},getTabNextCell:function(a,b){var c=this.getCellInfo(a),d=b||c.rowIndex,c=c.colIndex+1+(c.colSpan-1),
e;try{e=this.getCell(this.indexTable[d][c].rowIndex,this.indexTable[d][c].cellIndex)}catch(f){try{d=1*d+1,c=0,e=this.getCell(this.indexTable[d][c].rowIndex,this.indexTable[d][c].cellIndex)}catch(h){}}return e},getVSideCell:function(a,b,c){try{var d=this.getCellInfo(a),e,f,h=this.selectedTds.length&&!c,j=this.cellsRange;if(!b&&0==d.rowIndex||b&&(!h?d.rowIndex+d.rowSpan>this.rowsNum-1:j.endRowIndex==this.rowsNum-1))return null;e=!b?!h?d.rowIndex-1:j.beginRowIndex-1:!h?d.rowIndex+d.rowSpan:j.endRowIndex+
1;f=!h?d.colIndex:j.beginColIndex;return this.getCell(this.indexTable[e][f].rowIndex,this.indexTable[e][f].cellIndex)}catch(l){}},getSameEndPosCells:function(a,b){try{for(var c="x"===b.toLowerCase(),d=f.getXY(a)[c?"x":"y"]+a["offset"+(c?"Width":"Height")],e=this.table.rows,g=null,h=[],j=0;j<this.rowsNum;j++)for(var g=e[j].cells,l=0,k;k=g[l++];){var m=f.getXY(k)[c?"x":"y"]+k["offset"+(c?"Width":"Height")];if(m>d&&c)break;if(a==k||d==m)if(1==k[c?"colSpan":"rowSpan"]&&h.push(k),c)break}return h}catch(p){}},
...
c=b-a.length,d=this.getMaxCols();c--;)this.table.insertRow(a.length);this.rowsNum=b;this.colsNum=d;for(var c=0,e=a.length;c<e;c++)this.indexTable[c]=Array(d);for(var c=0,g;g=a[c];c++){var e=0,h;for(g=g.cells;h=g[e];e++){h.rowSpan>b&&(h.rowSpan=b);var j=e,l=h.rowSpan||1;for(h=h.colSpan||1;this.indexTable[c][j];)j++;for(var k=0;k<l;k++)for(var m=0;m<h;m++)this.indexTable[c+k][j+m]={rowIndex:c,cellIndex:e,colIndex:j,rowSpan:l,colSpan:h}}}for(k=0;k<b;k++)for(m=0;m<d;m++)void 0===this.indexTable[k][m]&&
(g=a[k],h=(h=g.cells[g.cells.length-1])?h.cloneNode(!0):this.table.ownerDocument.createElement("td"),this.setCellContent(h),1!==h.colSpan&&(h.colSpan=1),1!==h.rowSpan&&(h.rowSpan=1),g.appendChild(h),this.indexTable[k][m]={rowIndex:k,cellIndex:h.cellIndex,colIndex:m,rowSpan:1,colSpan:1});a=f.getElementsByTagName(this.table,"td");var n=[];p.each(a,function(a){f.hasClass(a,"selectTdClass")&&n.push(a)});n.length&&(b=n[n.length-1],a=this.getCellInfo(n[0]),b=this.getCellInfo(b),this.selectedTds=n,this.cellsRange=
{beginRowIndex:a.rowIndex,beginColIndex:a.colIndex,endRowIndex:b.rowIndex+b.rowSpan-1,endColIndex:b.colIndex+b.colSpan-1})},getCellInfo:function(a){if(a){var b=a.cellIndex;a=a.parentNode.rowIndex;for(var c=this.indexTable[a],d=this.colsNum,e=b;e<d;e++){var f=c[e];if(f.rowIndex===a&&f.cellIndex===b)return f}}},getCell:function(a,b){return a<this.rowsNum&&this.table.rows[a].cells[b]||null},deleteCell:function(a,b){b="number"==typeof b?b:a.parentNode.rowIndex;this.table.rows[b].deleteCell(a.cellIndex)},
getCellsRange:function(a,b){function c(a,b,e,f){var g=a,h=b,j=e,l=f,k,m,n;if(0<a)for(m=b;m<f;m++)k=d.indexTable[a][m],n=k.rowIndex,n<a&&(g=Math.min(n,g));if(f<d.colsNum)for(n=a;n<e;n++)k=d.indexTable[n][f],m=k.colIndex+k.colSpan-1,m>f&&(l=Math.max(m,l));if(e<d.rowsNum)for(m=b;m<f;m++)k=d.indexTable[e][m],n=k.rowIndex+k.rowSpan-1,n>e&&(j=Math.max(n,j));if(0<b)for(n=a;n<e;n++)k=d.indexTable[n][b],m=k.colIndex,m<b&&(h=Math.min(k.colIndex,h));return g!=a||h!=b||j!=e||l!=f?c(g,h,j,l):{beginRowIndex:a,
beginColIndex:b,endRowIndex:e,endColIndex:f}}try{var d=this,e=d.getCellInfo(a);if(a===b)return{beginRowIndex:e.rowIndex,beginColIndex:e.colIndex,endRowIndex:e.rowIndex+e.rowSpan-1,endColIndex:e.colIndex+e.colSpan-1};var f=d.getCellInfo(b),h=Math.min(e.rowIndex,f.rowIndex),j=Math.min(e.colIndex,f.colIndex),l=Math.max(e.rowIndex+e.rowSpan-1,f.rowIndex+f.rowSpan-1),k=Math.max(e.colIndex+e.colSpan-1,f.colIndex+f.colSpan-1);return c(h,j,l,k)}catch(m){}},getCells:function(a){this.clearSelected();for(var b=
a.beginColIndex,c=a.endRowIndex,d=a.endColIndex,e,f,h={},j=[],l=a.beginRowIndex;l<=c;l++)for(var k=b;k<=d;k++){a=this.indexTable[l][k];e=a.rowIndex;f=a.colIndex;var m=e+"|"+f;if(!h[m]){h[m]=1;if(e<l||f<k||e+a.rowSpan-1>c||f+a.colSpan-1>d)return null;j.push(this.getCell(e,a.cellIndex))}}return j},clearSelected:function(){J.removeSelectedClass(this.selectedTds);this.selectedTds=[];this.cellsRange={}},setSelected:function(a){var b=this.getCells(a);J.addSelectedClass(b);this.selectedTds=b;this.cellsRange=
a},isFullRow:function(){var a=this.cellsRange;return a.endColIndex-a.beginColIndex+1==this.colsNum},isFullCol:function(){var a=this.cellsRange,b=this.table.getElementsByTagName("th"),a=a.endRowIndex-a.beginRowIndex+1;return!b.length?a==this.rowsNum:a==this.rowsNum||a==this.rowsNum-1},getNextCell:function(a,b,c){try{var d=this.getCellInfo(a),e,f,h=this.selectedTds.length&&!c,j=this.cellsRange;if(!b&&0==d.rowIndex||b&&(!h?d.rowIndex+d.rowSpan>this.rowsNum-1:j.endRowIndex==this.rowsNum-1))return null;
e=!b?!h?d.rowIndex-1:j.beginRowIndex-1:!h?d.rowIndex+d.rowSpan:j.endRowIndex+1;f=!h?d.colIndex:j.beginColIndex;return this.getCell(this.indexTable[e][f].rowIndex,this.indexTable[e][f].cellIndex)}catch(l){}},getPreviewCell:function(a,b){try{var c=this.getCellInfo(a),d,e,f=this.selectedTds.length,h=this.cellsRange;if(!b&&(!f?!c.colIndex:!h.beginColIndex)||b&&(!f?c.rowIndex>this.colsNum-1:h.endColIndex==this.colsNum-1))return null;d=!b?!f?c.rowIndex:h.beginRowIndex:!f?1>c.rowIndex?0:c.rowIndex-1:h.beginRowIndex;
e=!b?!f?1>c.colIndex?0:c.colIndex-1:h.beginColIndex-1:!f?c.colIndex:h.endColIndex+1;return this.getCell(this.indexTable[d][e].rowIndex,this.indexTable[d][e].cellIndex)}catch(j){}},moveContent:function(a,b){if(!J.isEmptyBlock(b))if(J.isEmptyBlock(a))a.innerHTML=b.innerHTML;else{var c=a.lastChild;for((3==c.nodeType||!s.$block[c.tagName])&&a.appendChild(a.ownerDocument.createElement("br"));c=b.firstChild;)a.appendChild(c)}},mergeRight:function(a){var b=this.getCellInfo(a),c=this.indexTable[b.rowIndex][b.colIndex+
b.colSpan],d=this.getCell(c.rowIndex,c.cellIndex);a.colSpan=b.colSpan+c.colSpan;a.removeAttribute("width");this.moveContent(a,d);this.deleteCell(d,c.rowIndex);this.update()},mergeDown:function(a){var b=this.getCellInfo(a),c=this.indexTable[b.rowIndex+b.rowSpan][b.colIndex],d=this.getCell(c.rowIndex,c.cellIndex);a.rowSpan=b.rowSpan+c.rowSpan;a.removeAttribute("height");this.moveContent(a,d);this.deleteCell(d,c.rowIndex);this.update()},mergeRange:function(){var a=this.cellsRange,b=this.getCell(a.beginRowIndex,
this.indexTable[a.beginRowIndex][a.beginColIndex].cellIndex);if("TH"==b.tagName&&a.endRowIndex!==a.beginRowIndex)var c=this.indexTable,a=this.getCellInfo(b),b=this.getCell(1,c[1][a.colIndex].cellIndex),a=this.getCellsRange(b,this.getCell(c[this.rowsNum-1][a.colIndex].rowIndex,c[this.rowsNum-1][a.colIndex].cellIndex));for(var d=this.getCells(a),c=0,e;e=d[c++];)e!==b&&(this.moveContent(b,e),this.deleteCell(e));b.rowSpan=a.endRowIndex-a.beginRowIndex+1;1<b.rowSpan&&b.removeAttribute("height");b.colSpan=
a.endColIndex-a.beginColIndex+1;1<b.colSpan&&b.removeAttribute("width");b.rowSpan==this.rowsNum&&1!=b.colSpan&&(b.colSpan=1);if(b.colSpan==this.colsNum&&1!=b.rowSpan){d=b.parentNode.rowIndex;if(this.table.deleteRow){c=d+1;d+=1;for(a=b.rowSpan;c<a;c++)this.table.deleteRow(d)}else{c=0;for(a=b.rowSpan-1;c<a;c++)e=this.table.rows[d+1],e.parentNode.removeChild(e)}b.rowSpan=1}this.update()},insertRow:function(a,b){var c=this.colsNum,d=this.table,e=d.insertRow(a);parseInt((d.offsetWidth-20*c-c-1)/c,10);
if(0==a||a==this.rowsNum)for(var f=0;f<c;f++)d=this.cloneCell(b,!0),this.setCellContent(d),d.getAttribute("vAlign")&&d.setAttribute("vAlign",d.getAttribute("vAlign")),e.appendChild(d);else for(var h=this.indexTable[a],f=0;f<c;f++){var j=h[f];j.rowIndex<a?(d=this.getCell(j.rowIndex,j.cellIndex),d.rowSpan=j.rowSpan+1):(d=this.cloneCell(b,!0),this.setCellContent(d),e.appendChild(d))}this.update();return e},deleteRow:function(a){for(var b=this.table.rows[a],c=this.indexTable[a],d=this.colsNum,e=0,g=0;g<
d;){var h=c[g],j=this.getCell(h.rowIndex,h.cellIndex);if(1<j.rowSpan&&h.rowIndex==a){h=j.cloneNode(!0);h.rowSpan=j.rowSpan-1;h.innerHTML="";j.rowSpan=1;var l=a+1,k=this.table.rows[l],l=this.getPreviewMergedCellsNum(l,g)-e;l<g?(l=g-l-1,f.insertAfter(k.cells[l],h)):k.cells.length&&k.insertBefore(h,k.cells[0]);e+=1}g+=j.colSpan||1}a=[];e={};for(g=0;g<d;g++)j=c[g].rowIndex,h=c[g].cellIndex,k=j+"_"+h,e[k]||(e[k]=1,j=this.getCell(j,h),a.push(j));var m=[];p.each(a,function(a){1==a.rowSpan?a.parentNode.removeChild(a):
m.push(a)});p.each(m,function(a){a.rowSpan--});b.parentNode.removeChild(b);this.update()},insertCol:function(a,b,c){function d(a,b,c){0==a?(a=b.nextSibling||b.previousSibling,"TH"==a.tagName&&(a=b.ownerDocument.createElement("th"),a.appendChild(b.firstChild),c.insertBefore(a,b),f.remove(b))):"TH"==b.tagName&&(a=b.ownerDocument.createElement("td"),a.appendChild(b.firstChild),c.insertBefore(a,b),f.remove(b))}var e=this.rowsNum,g=0,h,j,l=parseInt((this.table.offsetWidth-20*(this.colsNum+1)-(this.colsNum+
1))/(this.colsNum+1),10),k;if(0==a||a==this.colsNum)for(;g<e;g++)h=this.table.rows[g],k=h.cells[0==a?a:h.cells.length],j=this.cloneCell(b,!0),this.setCellContent(j),j.setAttribute("vAlign",j.getAttribute("vAlign")),k&&j.setAttribute("width",k.getAttribute("width")),a?f.insertAfter(h.cells[h.cells.length-1],j):h.insertBefore(j,h.cells[0]),d(g,j,h);else for(;g<e;g++)k=this.indexTable[g][a],k.colIndex<a?(j=this.getCell(k.rowIndex,k.cellIndex),j.colSpan=k.colSpan+1):(h=this.table.rows[g],k=h.cells[k.cellIndex],
j=this.cloneCell(b,!0),this.setCellContent(j),j.setAttribute("vAlign",j.getAttribute("vAlign")),k&&j.setAttribute("width",k.getAttribute("width")),k?h.insertBefore(j,k):h.appendChild(j)),d(g,j,h);this.update();this.updateWidth(l,c||{tdPadding:10,tdBorder:1})},updateWidth:function(a,b){var c=this.table,d=J.getWidth(c)-2*b.tdPadding-b.tdBorder+a;d<c.ownerDocument.body.offsetWidth?c.setAttribute("width",d):(c=f.getElementsByTagName(this.table,"td"),p.each(c,function(b){b.setAttribute("width",a)}))},
deleteCol:function(a){for(var b=this.indexTable,c=this.table.rows,d=this.table.getAttribute("width"),e=0,f=this.rowsNum,h={},j=0;j<f;){var l=b[j][a],k=l.rowIndex+"_"+l.colIndex;h[k]||(h[k]=1,k=this.getCell(l.rowIndex,l.cellIndex),e||(e=k&&parseInt(k.offsetWidth/k.colSpan,10).toFixed(0)),1<k.colSpan?k.colSpan--:c[j].deleteCell(l.cellIndex),j+=l.rowSpan||1)}this.table.setAttribute("width",d-e);this.update()},splitToCells:function(a){var b=this;a=this.splitToRows(a);p.each(a,function(a){b.splitToCols(a)})},
splitToRows:function(a){var b=this.getCellInfo(a),c=b.rowIndex,d=b.colIndex,e=[];a.rowSpan=1;e.push(a);for(var f=c,h=c+b.rowSpan;f<h;f++)if(f!=c){var j=this.table.rows[f].insertCell(d-this.getPreviewMergedCellsNum(f,d));j.colSpan=b.colSpan;this.setCellContent(j);j.setAttribute("vAlign",a.getAttribute("vAlign"));j.setAttribute("align",a.getAttribute("align"));a.style.cssText&&(j.style.cssText=a.style.cssText);e.push(j)}this.update();return e},getPreviewMergedCellsNum:function(a,b){for(var c=this.indexTable[a],
d=0,e=0;e<b;)var f=c[e].colSpan,d=d+(f-(c[e].rowIndex==a?1:0)),e=e+f;return d},splitToCols:function(a){var b=(a.offsetWidth/a.colSpan-22).toFixed(0),c=this.getCellInfo(a),d=c.rowIndex,e=c.colIndex,g=[];a.colSpan=1;a.setAttribute("width",b);g.push(a);for(var h=e,j=e+c.colSpan;h<j;h++)if(h!=e){var l=this.table.rows[d],k=l.insertCell(this.indexTable[d][h].cellIndex+1);k.rowSpan=c.rowSpan;this.setCellContent(k);k.setAttribute("vAlign",a.getAttribute("vAlign"));k.setAttribute("align",a.getAttribute("align"));
...
this.getCellInfo(a[0]);var b=this,c=a[0],d=c.parentNode,e=0,f=0,h;p.each(a,function(a){a.parentNode==d&&(f+=a.colSpan||1);e+=a.rowSpan*a.colSpan||1});h=e/f;p.each(a,function(a){if(b.isLastCell(a,h,f))return c=a,!1});return c},selectRow:function(a){var b=this.indexTable[a];a=this.getCell(b[0].rowIndex,b[0].cellIndex);b=this.getCell(b[this.colsNum-1].rowIndex,b[this.colsNum-1].cellIndex);a=this.getCellsRange(a,b);this.setSelected(a)},selectTable:function(){var a=this.table.getElementsByTagName("td"),
a=this.getCellsRange(a[0],a[a.length-1]);this.setSelected(a)},sortTable:function(a,b){var c=this.table,d=c.rows,e=[],f="TH"===d[0].cells[0].tagName,h=0;if(this.selectedTds.length){for(var j=this.cellsRange,l=j.endRowIndex+1,k=j.beginRowIndex;k<l;k++)e[k]=d[k];e.splice(0,j.beginRowIndex);h=j.endRowIndex+1===this.rowsNum?0:j.endRowIndex+1}else{k=0;for(l=d.length;k<l;k++)e[k]=d[k]}f&&e.splice(0,1);e=p.sort(e,function(c,d){return b?"number"===typeof b?b:b.call(this,c.cells[a],d.cells[a]):(c.cells[a].innerText||
c.cells[a].textContent).localeCompare(d.cells[a].innerText||d.cells[a].textContent)});f=c.ownerDocument.createDocumentFragment();k=0;for(l=e.length;k<l;k++)f.appendChild(e[k]);c=c.getElementsByTagName("tbody")[0];h?c.insertBefore(f,d[h-j.endRowIndex+j.beginRowIndex-1]):c.appendChild(f)},setBackground:function(a,b){if("string"===typeof b)p.each(a,function(a){a.style.backgroundColor=b});else if("object"===typeof b){b=p.extend({repeat:!0,colorList:["#ddd","#fff"]},b);for(var c=this.getCellInfo(a[0]).rowIndex,
d=0,e=b.colorList,f=0,h;h=a[f++];){var j=this.getCellInfo(h);h=h.style;j=c+d==j.rowIndex?d:++d;h.backgroundColor=e[j]?e[j]:b.repeat?e[j%e.length]:""}}},removeBackground:function(a){p.each(a,function(a){a.style.backgroundColor=""})}};var id=function(a,b,c){var d=a.body;return d.offsetWidth-(b?2*parseInt(f.getComputedStyle(d,"margin-left"),10):0)-2*c.tableBorder-(a.options.offsetWidth||0)},$=function(a){if(a=w(a).cell){var b=B(a);return b.selectedTds.length?b.selectedTds:[a]}return[]},M=UE.UETable,
w=function(a){return M.getTableItemsByRange(a)},B=function(a){return M.getUETable(a)};UE.commands.inserttable={queryCommandState:function(){return w(this).table?-1:0},execCommand:function(a,b){b||(b=p.extend({},{numCols:this.options.defaultCols,numRows:this.options.defaultRows,tdvalign:this.options.tdvalign}));var c=this.selection.getRange().startContainer,c=f.findParent(c,function(a){return f.isBlockElm(a)},!0)||this.body,d=M.getDefaultValue(this,void 0),c=Math.floor(c.offsetWidth/b.numCols-2*d.tdPadding-
d.tdBorder);!b.tdvalign&&(b.tdvalign=this.options.tdvalign);this.execCommand("inserthtml",function(a,b){for(var c=[],d=a.numRows,l=a.numCols,k=0;k<d;k++){c.push("<tr>");for(var m=0;m<l;m++)c.push('<td width="'+b+'"  vAlign="'+a.tdvalign+'" >'+(n.ie?f.fillChar:"<br/>")+"</td>");c.push("</tr>")}return"<table><tbody>"+c.join("")+"</tbody></table>"}(b,c))}};UE.commands.insertparagraphbeforetable={queryCommandState:function(){return w(this).cell?0:-1},execCommand:function(){var a=w(this).table;if(a){var b=
this.document.createElement("p");b.innerHTML=n.ie?"&nbsp;":"<br />";a.parentNode.insertBefore(b,a);this.selection.getRange().setStart(b,0).setCursor()}}};UE.commands.deletetable={queryCommandState:function(){var a=this.selection.getRange();return f.findParentByTagName(a.startContainer,"table",!0)?0:-1},execCommand:function(a,b){var c=this.selection.getRange();if(b=b||f.findParentByTagName(c.startContainer,"table",!0)){var d=b.nextSibling;d||(d=f.createElement(this.document,"p",{innerHTML:n.ie?f.fillChar:
"<br/>"}),b.parentNode.insertBefore(d,b));f.remove(b);c=this.selection.getRange();3==d.nodeType?c.setStartBefore(d):c.setStart(d,0);c.setCursor(!1,!0);this.fireEvent("tablehasdeleted")}}};UE.commands.cellalign={queryCommandState:function(){return $(this).length?0:-1},execCommand:function(a,b){var c=$(this);if(c.length)for(var d=0,e;e=c[d++];)e.setAttribute("align",b)}};UE.commands.cellvalign={queryCommandState:function(){return $(this).length?0:-1},execCommand:function(a,b){var c=$(this);if(c.length)for(var d=
0,e;e=c[d++];)e.setAttribute("vAlign",b)}};UE.commands.insertcaption={queryCommandState:function(){var a=w(this).table;return a?0==a.getElementsByTagName("caption").length?1:-1:-1},execCommand:function(){var a=w(this).table;if(a){var b=this.document.createElement("caption");b.innerHTML=n.ie?f.fillChar:"<br/>";a.insertBefore(b,a.firstChild);this.selection.getRange().setStart(b,0).setCursor()}}};UE.commands.deletecaption={queryCommandState:function(){var a=this.selection.getRange();return(a=f.findParentByTagName(a.startContainer,
"table"))?0==a.getElementsByTagName("caption").length?-1:1:-1},execCommand:function(){var a=this.selection.getRange();if(a=f.findParentByTagName(a.startContainer,"table"))f.remove(a.getElementsByTagName("caption")[0]),this.selection.getRange().setStart(a.rows[0].cells[0],0).setCursor()}};UE.commands.inserttitle={queryCommandState:function(){var a=w(this).table;return a?0==a.rows[0].getElementsByTagName("th").length?0:-1:-1},execCommand:function(){var a=w(this).table;a&&B(a).insertRow(0,"th");a=a.getElementsByTagName("th")[0];
this.selection.getRange().setStart(a,0).setCursor(!1,!0)}};UE.commands.deletetitle={queryCommandState:function(){var a=w(this).table;return a?a.rows[0].getElementsByTagName("th").length?0:-1:-1},execCommand:function(){var a=w(this).table;a&&f.remove(a.rows[0]);a=a.getElementsByTagName("td")[0];this.selection.getRange().setStart(a,0).setCursor(!1,!0)}};UE.commands.mergeright={queryCommandState:function(){var a=w(this);if(!a.cell)return-1;var b=B(a.table);if(b.selectedTds.length)return-1;var a=b.getCellInfo(a.cell),
c=a.colIndex+a.colSpan;if(c>=b.colsNum)return-1;b=b.indexTable[a.rowIndex][c];return b.rowIndex==a.rowIndex&&b.rowSpan==a.rowSpan?0:-1},execCommand:function(){var a=this.selection.getRange(),b=a.createBookmark(!0),c=w(this).cell;B(c).mergeRight(c);a.moveToBookmark(b).select()}};UE.commands.mergedown={queryCommandState:function(){var a=w(this),b=a.cell;if(!b||"TH"==b.tagName)return-1;var c=B(a.table);if(c.selectedTds.length)return-1;var b=c.getCellInfo(a.cell),d=b.rowIndex+b.rowSpan;if(d>=c.rowsNum)return-1;
c=c.indexTable[d][b.colIndex];return c.colIndex==b.colIndex&&c.colSpan==b.colSpan&&"TH"!==a.cell.tagName?0:-1},execCommand:function(){var a=this.selection.getRange(),b=a.createBookmark(!0),c=w(this).cell;B(c).mergeDown(c);a.moveToBookmark(b).select()}};UE.commands.mergecells={queryCommandState:function(){return M.getUETableBySelected(this)?0:-1},execCommand:function(){var a=M.getUETableBySelected(this);if(a&&a.selectedTds.length){var b=a.selectedTds[0];a.mergeRange();a=this.selection.getRange();f.isEmptyBlock(b)?
a.setStart(b,0).collapse(!0):a.selectNodeContents(b);a.select()}}};UE.commands.insertrow={queryCommandState:function(){var a=w(this),b=a.cell;return b&&"TD"==b.tagName&&B(a.table).rowsNum<this.options.maxRowNum?0:-1},execCommand:function(){var a=this.selection.getRange(),b=a.createBookmark(!0),c=w(this),d=c.cell,c=c.table,e=B(c),f=e.getCellInfo(d);if(e.selectedTds.length)for(var f=e.cellsRange,h=0,j=f.endRowIndex-f.beginRowIndex+1;h<j;h++)e.insertRow(f.beginRowIndex,d);else e.insertRow(f.rowIndex,
d);a.moveToBookmark(b).select();"enabled"===c.getAttribute("interlaced")&&this.fireEvent("interlacetable",c)}};UE.commands.insertrownext={queryCommandState:function(){var a=w(this),b=a.cell;return b&&"TD"==b.tagName&&B(a.table).rowsNum<this.options.maxRowNum?0:-1},execCommand:function(){var a=this.selection.getRange(),b=a.createBookmark(!0),c=w(this),d=c.cell,c=c.table,e=B(c),f=e.getCellInfo(d);if(e.selectedTds.length)for(var f=e.cellsRange,h=0,j=f.endRowIndex-f.beginRowIndex+1;h<j;h++)e.insertRow(f.endRowIndex+
1,d);else e.insertRow(f.rowIndex+f.rowSpan,d);a.moveToBookmark(b).select();"enabled"===c.getAttribute("interlaced")&&this.fireEvent("interlacetable",c)}};UE.commands.deleterow={queryCommandState:function(){if(!w(this).cell)return-1},execCommand:function(){var a=w(this).cell,b=B(a),c=b.cellsRange,d=b.getCellInfo(a),e=b.getVSideCell(a),g=b.getVSideCell(a,!0),a=this.selection.getRange();if(p.isEmptyObject(c))b.deleteRow(d.rowIndex);else for(var h=c.beginRowIndex;h<c.endRowIndex+1;h++)b.deleteRow(c.beginRowIndex);
h=b.table;if(h.getElementsByTagName("td").length)if(1==d.rowSpan||d.rowSpan==c.endRowIndex-c.beginRowIndex+1){if(g||e)a.selectNodeContents(g||e).setCursor(!1,!0)}else(b=b.getCell(d.rowIndex,b.indexTable[d.rowIndex][d.colIndex].cellIndex))&&a.selectNodeContents(b).setCursor(!1,!0);else b=h.nextSibling,f.remove(h),b&&a.setStart(b,0).setCursor(!1,!0);"enabled"===h.getAttribute("interlaced")&&this.fireEvent("interlacetable",h)}};UE.commands.insertcol={queryCommandState:function(){var a=w(this),b=a.cell;
return b&&("TD"==b.tagName||"TH"==b.tagName)&&B(a.table).colsNum<this.options.maxColNum?0:-1},execCommand:function(a){var b=this.selection.getRange(),c=b.createBookmark(!0);if(-1!=this.queryCommandState(a)){a=w(this).cell;var d=B(a),e=d.getCellInfo(a);if(d.selectedTds.length)for(var e=d.cellsRange,f=0,h=e.endColIndex-e.beginColIndex+1;f<h;f++)d.insertCol(e.beginColIndex,a);else d.insertCol(e.colIndex,a);b.moveToBookmark(c).select(!0)}}};UE.commands.insertcolnext={queryCommandState:function(){var a=
w(this);return a.cell&&B(a.table).colsNum<this.options.maxColNum?0:-1},execCommand:function(){var a=this.selection.getRange(),b=a.createBookmark(!0),c=w(this).cell,d=B(c),e=d.getCellInfo(c);if(d.selectedTds.length)for(var e=d.cellsRange,f=0,h=e.endColIndex-e.beginColIndex+1;f<h;f++)d.insertCol(e.endColIndex+1,c);else d.insertCol(e.colIndex+e.colSpan,c);a.moveToBookmark(b).select()}};UE.commands.deletecol={queryCommandState:function(){if(!w(this).cell)return-1},execCommand:function(){var a=w(this).cell,
b=B(a),c=b.cellsRange,d=b.getCellInfo(a),e=b.getHSideCell(a),g=b.getHSideCell(a,!0);if(p.isEmptyObject(c))b.deleteCol(d.colIndex);else for(d=c.beginColIndex;d<c.endColIndex+1;d++)b.deleteCol(c.beginColIndex);b=b.table;c=this.selection.getRange();b.getElementsByTagName("td").length?f.inDoc(a,this.document)?c.setStart(a,0).setCursor(!1,!0):g&&f.inDoc(g,this.document)?c.selectNodeContents(g).setCursor(!1,!0):e&&f.inDoc(e,this.document)&&c.selectNodeContents(e).setCursor(!0,!0):(a=b.nextSibling,f.remove(b),
a&&c.setStart(a,0).setCursor(!1,!0))}};UE.commands.splittocells={queryCommandState:function(){var a=w(this),b=a.cell;return!b||0<B(a.table).selectedTds.length?-1:b&&(1<b.colSpan||1<b.rowSpan)?0:-1},execCommand:function(){var a=this.selection.getRange(),b=a.createBookmark(!0),c=w(this).cell;B(c).splitToCells(c);a.moveToBookmark(b).select()}};UE.commands.splittorows={queryCommandState:function(){var a=w(this),b=a.cell;return!b||0<B(a.table).selectedTds.length?-1:b&&1<b.rowSpan?0:-1},execCommand:function(){var a=
this.selection.getRange(),b=a.createBookmark(!0),c=w(this).cell;B(c).splitToRows(c);a.moveToBookmark(b).select()}};UE.commands.splittocols={queryCommandState:function(){var a=w(this),b=a.cell;return!b||0<B(a.table).selectedTds.length?-1:b&&1<b.colSpan?0:-1},execCommand:function(){var a=this.selection.getRange(),b=a.createBookmark(!0),c=w(this).cell;B(c).splitToCols(c);a.moveToBookmark(b).select()}};UE.commands.adaptbytext=UE.commands.adaptbywindow={queryCommandState:function(){return w(this).table?
0:-1},execCommand:function(a){var b=w(this).table;if(b)if("adaptbywindow"==a){var c=b.getElementsByTagName("td");p.each(c,function(a){a.removeAttribute("width")});b.setAttribute("width",id(this,!0,M.getDefaultValue(this,b)));setTimeout(function(){p.each(c,function(a){1==a.colSpan&&a.setAttribute("width",a.offsetWidth+"")})},0)}else a=f.getElementsByTagName(b,"td th"),p.each(a,function(a){a.removeAttribute("width")}),b.removeAttribute("width")}};UE.commands.averagedistributecol={queryCommandState:function(){var a=
M.getUETableBySelected(this);return!a?-1:a.isFullRow()||a.isFullCol()?0:-1},execCommand:function(){var a=M.getUETableBySelected(this);if(a&&a.selectedTds.length){var b=a.table,c=0,d=0,e=M.getDefaultValue(this,b);if(a.isFullRow())c=b.offsetWidth,d=a.colsNum;else for(var b=a.cellsRange.endColIndex,g,h=a.cellsRange.beginColIndex;h<=b;)g=a.selectedTds[h],c+=g.offsetWidth,h+=g.colSpan,d+=1;var j=Math.ceil(c/d)-2*e.tdBorder-2*e.tdPadding;p.each(f.getElementsByTagName(a.table,"th"),function(a){a.setAttribute("width",
"")});a=a.isFullRow()?f.getElementsByTagName(a.table,"td"):a.selectedTds;p.each(a,function(a){1==a.colSpan&&a.setAttribute("width",j)})}}};UE.commands.averagedistributerow={queryCommandState:function(){var a=M.getUETableBySelected(this);return!a||a.selectedTds&&/th/ig.test(a.selectedTds[0].tagName)?-1:a.isFullRow()||a.isFullCol()?0:-1},execCommand:function(){var a=M.getUETableBySelected(this);if(a&&a.selectedTds.length){var b,c=0;b=a.table;var d=M.getDefaultValue(this,b),e=parseInt(f.getComputedStyle(b.getElementsByTagName("td")[0],
"padding-top"));if(a.isFullCol()){var c=f.getElementsByTagName(b,"caption"),g=f.getElementsByTagName(b,"th"),h,j;0<c.length&&(h=c[0].offsetHeight);0<g.length&&(j=g[0].offsetHeight);c=b.offsetHeight-(h||0)-(j||0);b=0==g.length?a.rowsNum:a.rowsNum-1}else{j=a.cellsRange.beginRowIndex;g=a.cellsRange.endRowIndex;h=0;for(b=f.getElementsByTagName(b,"tr");j<=g;j++)c+=b[j].offsetHeight,h+=1;b=h}var l=n.ie&&9>n.version?Math.ceil(c/b):Math.ceil(c/b)-2*d.tdBorder-2*e,a=a.isFullCol()?f.getElementsByTagName(a.table,
"td"):a.selectedTds;p.each(a,function(a){1==a.rowSpan&&a.setAttribute("height",l)})}}};UE.commands.cellalignment={queryCommandState:function(){return w(this).table?0:-1},execCommand:function(a,b){var c=M.getUETableBySelected(this);c?p.each(c.selectedTds,function(a){f.setAttributes(a,b)}):(c=(c=this.selection.getStart())&&f.findParentByTagName(c,["td","th","caption"],!0),/caption/ig.test(c.tagName)?(c.style.textAlign=b.align,c.style.verticalAlign=b.vAlign):f.setAttributes(c,b),this.selection.getRange().setCursor(!0))},
queryCommandValue:function(){var a=w(this).cell;a||(a=$(this)[0]);if(a){var b=UE.UETable.getUETable(a).selectedTds;!b.length&&(b=a);return UE.UETable.getTableCellAlignState(b)}return null}};UE.commands.tablealignment={queryCommandState:function(){return n.ie&&8>n.version?-1:w(this).table?0:-1},execCommand:function(a,b){var c=this.selection.getStart();(c=c&&f.findParentByTagName(c,["table"],!0))&&c.setAttribute("align",b)}};UE.commands.edittable={queryCommandState:function(){return w(this).table?0:
-1},execCommand:function(a,b){var c=this.selection.getRange();if(c=f.findParentByTagName(c.startContainer,"table"))c=f.getElementsByTagName(c,"td").concat(f.getElementsByTagName(c,"th"),f.getElementsByTagName(c,"caption")),p.each(c,function(a){a.style.borderColor=b})}};UE.commands.edittd={queryCommandState:function(){return w(this).table?0:-1},execCommand:function(a,b){var c=M.getUETableBySelected(this);if(c)p.each(c.selectedTds,function(a){a.style.backgroundColor=b});else if(c=(c=this.selection.getStart())&&
f.findParentByTagName(c,["td","th","caption"],!0))c.style.backgroundColor=b}};UE.commands.sorttable={queryCommandState:function(){var a=w(this);if(!a.cell)return-1;for(var a=a.table.getElementsByTagName("td"),b=0,c;c=a[b++];)if(1!=c.rowSpan||1!=c.colSpan)return-1;return 0},execCommand:function(a,b){var c=this.selection.getRange(),d=c.createBookmark(!0),e=w(this),f=e.cell,e=B(e.table),f=e.getCellInfo(f);e.sortTable(f.cellIndex,b);c.moveToBookmark(d).select()}};UE.commands.enablesort=UE.commands.disablesort=
{queryCommandState:function(){return w(this).table?0:-1},execCommand:function(a){w(this).table.setAttribute("data-sort","enablesort"==a?"sortEnabled":"sortDisabled")}};UE.commands.settablebackground={queryCommandState:function(){return 1<$(this).length?0:-1},execCommand:function(a,b){var c;c=$(this);B(c[0]).setBackground(c,b)}};UE.commands.cleartablebackground={queryCommandState:function(){var a=$(this);if(!a.length)return-1;for(var b=0,c;c=a[b++];)if(""!==c.style.backgroundColor)return 0;return-1},
execCommand:function(){var a=$(this);B(a[0]).removeBackground(a)}};UE.commands.interlacetable=UE.commands.uninterlacetable={queryCommandState:function(a){var b=w(this).table;if(!b)return-1;b=b.getAttribute("interlaced");return"interlacetable"==a?"enabled"===b?-1:0:!b||"disabled"===b?-1:0},execCommand:function(a,b){var c=w(this).table;"interlacetable"==a?(c.setAttribute("interlaced","enabled"),this.fireEvent("interlacetable",c,b)):(c.setAttribute("interlaced","disabled"),this.fireEvent("uninterlacetable",
c))}};UE.plugins.table=function(){function a(a,b,c){a.style[b]&&(c&&a.setAttribute(b,parseInt(a.style[b],10)),a.style[b]="")}function b(a){if("TD"==a.tagName||"TH"==a.tagName)return a;var b;return(b=f.findParentByTagName(a,"td",!0)||f.findParentByTagName(a,"th",!0))?b:null}function c(a){var b=RegExp(f.fillChar,"g");if(0<a[n.ie?"innerText":"textContent"].replace(/^\s*$/,"").replace(b,"").length)return 0;for(var c in s.$isNotEmpty)if(a.getElementsByTagName(c).length)return 0;return 1}function d(a){return a.pageX||
a.pageY?{x:a.pageX,y:a.pageY}:{x:a.clientX+r.document.body.scrollLeft-r.document.body.clientLeft,y:a.clientY+r.document.body.scrollTop-r.document.body.clientTop}}function e(a){if(!t())try{var c=b(a.target||a.srcElement),e;if(C&&(r.body.style.webkitUserSelect="none",Math.abs(R.x-a.clientX)>T||Math.abs(R.y-a.clientY)>T))m(),C=!1,I=0,q(a);if(O&&ba)if(I=0,r.body.style.webkitUserSelect="none",r.selection.getNative()[n.ie?"empty":"removeAllRanges"](),e=d(a),j(r,!0,O,e,c),"h"==O){var k=ca.style,p;var c=
ba,s=S(c);if(s){var ac=s.getSameEndPosCells(c,"x")[0],ab=s.getSameStartPosXCells(c)[0],ea=d(a).x,fa=(ac?f.getXY(ac).x:f.getXY(s.table).x)+20,u=ab?f.getXY(ab).x+ab.offsetWidth-20:r.body.offsetWidth+5||parseInt(f.getComputedStyle(r.body,"width"),10),fa=fa+M,u=u-M;p=ea<fa?fa:ea>u?u:ea}else p=void 0;k.left=p+"px"}else{if("v"==O){var ga=ca.style,w;a:{try{var x=f.getXY(ba).y,y=d(a).y;w=y<x?x:y;break a}catch(A){}w=void 0}ga.top=w+"px"}}else if(c){if(!0!==r.fireEvent("excludetable",c)){e=d(a);var ka=l(c,
e),D=f.findParentByTagName(c,"table",!0);h(D,c,a,!0)?!0!==r.fireEvent("excludetable",D)&&(r.body.style.cursor="url("+r.options.cursorpath+"h.png),pointer"):h(D,c,a)?!0!==r.fireEvent("excludetable",D)&&(r.body.style.cursor="url("+r.options.cursorpath+"v.png),pointer"):(r.body.style.cursor="text",/\d/.test(ka)&&(ka=ka.replace(/\d/,""),c=S(c).getPreviewCell(c,"v"==ka)),j(r,c?!!ka:!1,c?ka:"",e,c))}}else g(!1,D,r)}catch(z){}}function g(a,b,c){if(a){a=f.getXY(b);var d=b.ownerDocument;if(!L||!L.parentNode){L=
d.createElement("div");L.contentEditable=!1;L.innerHTML="";L.style.cssText="width:15px;height:15px;background-image:url("+c.options.UEDITOR_HOME_URL+"dialogs/table/dragicon.png);position: absolute;cursor:move;top:"+(a.y-15)+"px;left:"+a.x+"px;";f.unSelectable(L);L.onmouseover=function(){Z=!0};L.onmouseout=function(){Z=!1};f.on(L,"click",function(){var a=this;clearTimeout(e);e=setTimeout(function(){c.fireEvent("tableClicked",b,a)},300)});f.on(L,"dblclick",function(){clearTimeout(e);var a=S(b),d=b.rows[0].cells[0],
f=a.getLastCell(),f=a.getCellsRange(d,f);c.selection.getRange().setStart(d,0).setCursor(!1,!0);a.setSelected(f)});f.on(L,"dragstart",function(a,b){f.preventDefault(b)});var e;d.body.appendChild(L)}}else Z||setTimeout(function(){!Z&&L&&L.parentNode&&L.parentNode.removeChild(L)},2E3)}function h(a,b,c,e){c=d(c);b=l(b,c);return e?(e=(e=a.getElementsByTagName("caption")[0])?e.offsetHeight:0,"v1"==b&&8>c.y-f.getXY(a).y-e):"h1"==b&&8>c.x-f.getXY(a).x}function j(a,b,c,d,e){try{a.body.style.cursor="h"==c?
"col-resize":"v"==c?"row-resize":"text",n.ie&&(c&&!V&&!F.getUETableBySelected(a)?(Y(a,a.document),E(c,e)):B(a)),aa=b}catch(f){}}function l(a,b){var c=f.getXY(a);return!c?"":c.x+a.offsetWidth-b.x<P?"h":b.x-c.x<P?"h1":c.y+a.offsetHeight-b.y<P?"v":b.y-c.y<P?"v1":""}function k(a,b){if(!t())if(R={x:b.clientX,y:b.clientY},2==b.button){var c=F.getUETableBySelected(r),d=!1;if(c){var e=J(r,b);p.each(c.selectedTds,function(a){a===e&&(d=!0)});d?(e=c.selectedTds[0],setTimeout(function(){r.selection.getRange().setStart(e,
0).setCursor(!1,!0)},0)):(W(f.getElementsByTagName(r.body,"th td")),c.clearSelected())}}else if(W(f.getElementsByTagName(r.body,"td th")),p.each(r.document.getElementsByTagName("table"),function(a){a.ueTable=null}),Q=J(r,b))if(c=f.findParentByTagName(Q,"table",!0),(ut=S(c))&&ut.clearSelected(),aa){var g=b;if(n.ie){var c=g,h="pageX pageY clientX clientY srcElement target".split(" "),j={};if(c)for(var l=0,k,s;k=h[l];l++)(s=c[k])&&(j[k]=s);g=j}m();C=!0;H=setTimeout(function(){q(g)},$)}else r.document.body.style.webkitUserSelect=
"",V=!0,r.addListener("mouseover",w)}function m(){H&&clearTimeout(H);H=null}function q(a){C=!1;Q&&(a=Math.abs(R.x-a.clientX)>=Math.abs(R.y-a.clientY)?"h":"v",/\d/.test(a)&&(a=a.replace(/\d/,""),Q=S(Q).getPreviewCell(Q,"v"==a)),B(r),Y(r,r.document),r.fireEvent("saveScene"),E(a,Q),V=!0,O=a,ba=Q)}function u(a,c){if(!t()){m();C=!1;if(aa&&(I=++I%3,R={x:c.clientX,y:c.clientY},setTimeout(function(){0<I&&I--},$),2===I)){I=0;var e;I=0;e=c||r.window.event;var g=b(e.target||e.srcElement);if(g){var j;if(j=l(g,
d(e)))if(B(r),"h1"==j&&(j="h",h(f.findParentByTagName(g,"table"),g,e)?r.execCommand("adaptbywindow"):(g=S(g).getPreviewCell(g))&&r.selection.getRange().selectNodeContents(g).setCursor(!0,!0)),"h"==j){e=S(g);var k=x(g,e.table,!0),g=k;j=[];for(var q=null,s=0,ea=g.length;s<ea;s++)(q=g[s].left)&&j.push(q);k=j;e.width=e.offsetWidth;var fa=[],v=[];p.each(k,function(a){fa.push(a.offsetWidth)});p.each(k,function(a){a.removeAttribute("width")});window.setTimeout(function(){var a=!0;p.each(k,function(b,c){var d=
b.offsetWidth;if(d>fa[c])return a=!1;v.push(d)});var b=a?v:fa;p.each(k,function(a,c){a.width=b[c]-z()})},0)}}return}if(2!=c.button){e=this.selection.getRange();g=f.findParentByTagName(e.startContainer,"table",!0);j=f.findParentByTagName(e.endContainer,"table",!0);if(g||j)g===j?(g=f.findParentByTagName(e.startContainer,["td","th","caption"],!0),j=f.findParentByTagName(e.endContainer,["td","th","caption"],!0),g!==j&&this.selection.clearRange()):this.selection.clearRange();V=!1;this.document.body.style.webkitUserSelect=
"";if(O&&ba){this.selection.getNative()[n.ie?"empty":"removeAllRanges"]();I=0;ca=this.document.getElementById("ue_tableDragLine");j=f.getXY(ba);q=f.getXY(ca);switch(O){case "h":e=ba;var ga=q.x-j.x;if(g=S(e)){g=g.table;j=x(e,g);g.style.width="";g.removeAttribute("width");var u=ga,u=u-z();if(0>u)ga=0;else{var u=u-y(e),Y=0>u?"left":"right",u=Math.abs(u);p.each(j,function(a){(a=a[Y])&&(u=Math.min(u,y(a)-M))});u=0>u?0:u;ga="left"===Y?-u:u}e.nextSibling?p.each(j,function(a){a.left.width=+a.left.width+ga;
a.right&&(a.right.width=+a.right.width-ga)}):p.each(j,function(a){a.left.width-=-ga})}break;case "v":if(g=ba,e=q.y-j.y-ba.offsetHeight,!(10>Math.abs(e))&&(j=S(g))){g=j.getSameEndPosCells(g,"y");j=g[0]?g[0].offsetHeight:0;for(q=0;s=g[q++];){var ja=e,jd=j,ea=parseInt(f.getComputedStyle(s,"line-height"),10),ja=jd+ja,ja=ja<ea?ea:ja;s.style.height&&(s.style.height="");1==s.rowSpan?s.setAttribute("height",ja):s.removeAttribute&&s.removeAttribute("height")}}}O="";ba=null;B(this);this.fireEvent("saveScene")}else{if(Q)(g=
(e=S(Q))?e.selectedTds[0]:null)?(e=new X.Range(this.document),f.isEmptyBlock(g)?e.setStart(g,0).setCursor(!1,!0):e.selectNodeContents(g).shrinkBoundary().setCursor(!1,!0)):(e=this.selection.getRange().shrinkBoundary(),e.collapsed||(g=f.findParentByTagName(e.startContainer,["td","th"],!0),j=f.findParentByTagName(e.endContainer,["td","th"],!0),(g&&!j||!g&&j||g&&j&&g!==j)&&e.setCursor(!1,!0))),Q=null,this.removeListener("mouseover",w);else if((g=f.findParentByTagName(c.target||c.srcElement,"td",!0))||
(g=f.findParentByTagName(c.target||c.srcElement,"th",!0)),g&&("TD"==g.tagName||"TH"==g.tagName)){if(!0===this.fireEvent("excludetable",g))return;e=new X.Range(this.document);e.setStart(g,0).setCursor(!1,!0)}this._selectionChange(250,c)}}}}function w(a,b){if(!t()){var c=b.target||b.srcElement;N=f.findParentByTagName(c,"td",!0)||f.findParentByTagName(c,"th",!0);if(Q&&N&&("TD"==Q.tagName&&"TD"==N.tagName||"TH"==Q.tagName&&"TH"==N.tagName)&&f.findParentByTagName(Q,"table")==f.findParentByTagName(N,"table"))if(c=
S(N),Q!=N){this.document.body.style.webkitUserSelect="none";this.selection.getNative()[n.ie?"empty":"removeAllRanges"]();var d=c.getCellsRange(Q,N);c.setSelected(d)}else this.document.body.style.webkitUserSelect="",c.clearSelected();b.preventDefault?b.preventDefault():b.returnValue=!1}}function t(){return"false"===r.body.contentEditable}function x(a,b,c){b||(b=f.findParentByTagName(a,"table"));if(!b)return null;f.getNodeIndex(a);b=b.rows;for(var d=0;a;)1===a.nodeType&&(d+=a.colSpan||1),a=a.previousSibling;
a=null;var e=[];p.each(b,function(a){var b=0;p.each(a.cells,function(a){b+=a.colSpan||1;if(b===d)return e.push({left:a,right:a.nextSibling||null}),!1;if(b>d)return c&&e.push({left:a}),!1})});return e}function y(a){var b=0,b=a.offsetWidth-z();if(!a.nextSibling){tab=f.findParentByTagName(a,"table",!1);if(void 0===tab.offsetVal){var c=a.previousSibling;tab.offsetVal=c?a.offsetWidth-c.offsetWidth===F.borderWidth?F.borderWidth:0:0}b-=tab.offsetVal}b=0>b?0:b;try{a.width=b}catch(d){}return b}function z(){if(void 0===
F.tabcellSpace){var a=r.document.createElement("table"),b=r.document.createElement("tbody"),c=r.document.createElement("tr"),d=r.document.createElement("td"),e=null;d.style.cssText="border: 0;";d.width=1;c.appendChild(d);c.appendChild(e=d.cloneNode(!1));b.appendChild(c);a.appendChild(b);a.style.cssText="visibility: hidden;";r.body.appendChild(a);F.paddingSpace=d.offsetWidth-1;b=a.offsetWidth;d.style.cssText="";e.style.cssText="";F.borderWidth=(a.offsetWidth-b)/3;F.tabcellSpace=F.paddingSpace+F.borderWidth;
r.body.removeChild(a)}z=function(){return F.tabcellSpace};return F.tabcellSpace}function Y(a){V||(ca=a.document.createElement("div"),f.setAttributes(ca,{id:"ue_tableDragLine",unselectable:"on",contenteditable:!1,onresizestart:"return false",ondragstart:"return false",onselectstart:"return false",style:"background-color:blue;position:absolute;padding:0;margin:0;background-image:none;border:0px none;opacity:0;filter:alpha(opacity=0)"}),a.body.appendChild(ca))}function B(a){if(!V)for(var b;b=a.document.getElementById("ue_tableDragLine");)f.remove(b)}
function E(a,b){if(b){var c=f.findParentByTagName(b,"table"),d=c.getElementsByTagName("caption"),e=c.offsetWidth,g=c.offsetHeight-(0<d.length?d[0].offsetHeight:0),c=f.getXY(c),h=f.getXY(b);switch(a){case "h":d="height:"+g+"px;top:"+(c.y+(0<d.length?d[0].offsetHeight:0))+"px;left:"+(h.x+b.offsetWidth);ca.style.cssText=d+"px;position: absolute;display:block;background-color:blue;width:1px;border:0; color:blue;opacity:.3;filter:alpha(opacity=30)";break;case "v":d="width:"+e+"px;left:"+c.x+"px;top:"+
(h.y+b.offsetHeight),ca.style.cssText=d+"px;overflow:hidden;position: absolute;display:block;background-color:blue;height:1px;border:0;color:blue;opacity:.2;filter:alpha(opacity=20)"}}}function G(a,b){for(var c=f.getElementsByTagName(a.body,"table"),d,e=0,g;g=c[e++];)d=f.getElementsByTagName(g,"td"),d[0]&&(b?(d=d[0].style.borderColor.replace(/\s/g,""),/(#ffffff)|(rgb\(255,f55,255\))/ig.test(d)&&f.addClass(g,"noBorderTable")):f.removeClasses(g,"noBorderTable"))}function K(a,b,c){var d=a.body;return d.offsetWidth-
(b?2*parseInt(f.getComputedStyle(d,"margin-left"),10):0)-2*c.tableBorder-(a.options.offsetWidth||0)}function J(a,b){var c=f.findParentByTagName(b.target||b.srcElement,["td","th"],!0),e=null;if(!c)return null;e=l(c,d(b));if(!c)return null;if("h1"===e&&c.previousSibling){var e=f.getXY(c),g=c.offsetWidth;Math.abs(e.x+g-b.clientX)>g/3&&(c=c.previousSibling)}else"v1"===e&&c.parentNode.previousSibling&&(e=f.getXY(c),g=c.offsetHeight,Math.abs(e.y+g-b.clientY)>g/3&&(c=c.parentNode.previousSibling.firstChild));
return c&&!0!==a.fireEvent("excludetable",c)?c:null}var r=this,H=null,M=5,C=!1,P=5,T=10,I=0,R=null,$=360,F=UE.UETable,S=function(a){return F.getUETable(a)},W=function(a){return F.removeSelectedClass(a)};r.ready(function(){var a=this,b=a.selection.getText;a.selection.getText=function(){var c=F.getUETableBySelected(a);if(c){var d="";p.each(c.selectedTds,function(a){d+=a[n.ie?"innerText":"textContent"]});return d}return b.call(a.selection)}});var Q=null,N=null,O="",aa=!1,L=null,Z=!1,ca=null,ba=null,
V=!1;r.setOpt({maxColNum:20,maxRowNum:100,defaultCols:5,defaultRows:5,tdvalign:"top",cursorpath:r.options.UEDITOR_HOME_URL+"themes/default/images/cursor_",tableDragable:!1,classList:["ue-table-interlace-color-single","ue-table-interlace-color-double"]});r.getUETable=S;var da={deletetable:1,inserttable:1,cellvalign:1,insertcaption:1,deletecaption:1,inserttitle:1,deletetitle:1,mergeright:1,mergedown:1,mergecells:1,insertrow:1,insertrownext:1,deleterow:1,insertcol:1,insertcolnext:1,deletecol:1,splittocells:1,
splittorows:1,splittocols:1,adaptbytext:1,adaptbywindow:1,adaptbycustomer:1,insertparagraph:1,insertparagraphbeforetable:1,averagedistributecol:1,averagedistributerow:1};r.ready(function(){p.cssRule("table",".selectTdClass{background-color:#edf5fa !important}table.noBorderTable td,table.noBorderTable th,table.noBorderTable caption{border:1px dashed #ddd !important}table{margin-bottom:10px;border-collapse:collapse;display:table;}td,th{padding: 5px 10px;border: 1px solid #DDD;}caption{border:1px dashed #DDD;border-bottom:0;padding:3px;text-align:center;}th{border-top:2px solid #BBB;background:#F7F7F7;}.ue-table-interlace-color-single{ background-color: #fcfcfc; } .ue-table-interlace-color-double{ background-color: #f7faff; }td p{margin:0;padding:0;}",
